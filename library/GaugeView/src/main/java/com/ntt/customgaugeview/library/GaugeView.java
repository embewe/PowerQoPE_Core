...
import com.ntt.customgaugeview.library.R;
        import android.annotation.TargetApi;
        import android.content.Context;
        import android.content.res.TypedArray;
        import android.graphics.Bitmap;
...
public class GaugeView extends View {
    ...
    public static final int INNER_CIRCLE_COLOR = Color.parseColor("#43A047");
    public static final int OUTER_CIRCLE_COLOR = Color.parseColor("#43A047");
    ...
    public static final float[] RANGE_VALUES = {500.0f};
    ...
    private static final float[] DEFAULT_RANGE_VALUES = new float[]{0.0f, 10.0f, 20.0f, 50.0f, 100.0f};
    private static final int DEFAULT_COLOR = Color.parseColor("#43A047");
    private static final int DEFAULT_FACE_COLOR = Color.parseColor("#292B2B");
