    ...
    private static class DateTypeConverter implements JsonSerializer<Date>,
        ...
        public Date deserialize(JsonElement json, Type type, JsonDeserializationContext context)
            ...
            try {
                ...
                throw new JsonParseException("Cannot convert time string: " + json);
            } catch (IllegalArgumentException e) {
                Logger.e("Cannot convert time string:" + json);
                throw new JsonParseException("Cannot convert time string: " + json);
            } catch (ParseException e) {
                throw new JsonParseException("Cannot convert UTC time string: " + json);
            }
        }
    }
