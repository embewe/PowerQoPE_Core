...
public class OpenVPNService extends VpnService implements Callback {
    ...
    public static final String START_SERVICE = "openvpn.START_SERVICE";
    public static final String START_SERVICE_STICKY = "openvpn.START_SERVICE_STICKY";
    public static final String ALWAYS_SHOW_NOTIFICATION = "openvpn.NOTIFICATION_ALWAYS_VISIBLE";
    public static final String DISCONNECT_VPN = "openvpn.DISCONNECT_VPN";
    private static final String PAUSE_VPN = "openvpn.PAUSE_VPN";
    private static final String RESUME_VPN = "openvpn.RESUME_VPN";
    ...
    private final boolean mDisplayBytecount = false;
    ...
    synchronized void unregisterDeviceStateReceiver() {
        if (mDeviceStateReceiver != null)
            try {
                ...
                // java.lang.IllegalArgumentException: Receiver not registered: openvpn.NetworkSateReceiver@41a61a10
                // Ignore for now ...
                iae.printStackTrace();
            }
    ...
    private OpenVPNManagement instantiateOpenVPN3Core() {
        try {
            Class cl = Class.forName("openvpn.core.OpenVPNThreadv3");
    ...
    private void doSendBroadcast(String state, ConnectionStatus level) {
        ...
        vpnstatus.setAction("openvpn.VPN_STATUS");
